...
sys.path.append("/home/ssp/Documents/models/research")
...
pytesseract.pytesseract.tesseract_cmd = '/home/ssp/Documents/models/research'

os.chdir("/home/ssp/Documents/models/research/object_detection")
...
if not os.path.exists(MODEL_NAME + '/frozen_inference_graph.pb'):
    ...
    for file in tar_file.getmembers():
        ...
        if 'frozen_inference_graph.pb' in file_name:
            ...
            break  # Exit loop once file is found and extracted
    else:
...
PATH_TO_LABELS="/home/ssp/Documents/models/research/object_detection/data/mscoco_label_map.pbtxt"
